...
from ..db.session import save_agent_run, save_application_record, save_evidence_report
...
def run_tracker_agent(state: dict) -> dict:
    ...
    tracker_state = {
        **record,
        "skill_gap_report": {"overall_match": match_score},
    }
    approved_outputs = {
        "resume_bullets": record["approved_resume_bullets"],
        "cover_letter": record["approved_cover_letter"],
    }
    application_id = save_application_record(tracker_state, approved_outputs)
